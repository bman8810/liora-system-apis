...
Voice never e-prescribes. Refill and inventory requests land here as structured
messages for front desk / provider review.
...
class StaffMessageQueue:
    ...
    def enqueue(
        ...
        *,
        ...
        kind: rx_refill | product_refill | general | results | late | transfer
        ...
        return {
            ...
            "speak_hint": (
                ...
                "by the next business day — not a guarantee of same-day refill."
            ),
        }
    ...
    def _try_bottle(self, record: dict) -> dict | None:
        ...
        try:
            ...
            kwargs: dict[str, Any] = {
                ...
                "outcome_summary": str(record.get("subject") or record.get("kind") or "staff message"),
                "metadata": {
